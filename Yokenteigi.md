...
## 各学年の単元は"tangenlist.mdに移動
### 単元は、tangenlist, app.py, quiz_dataフォルダ、


問題作成指示

小学1年生、国語の各単元で問題が存在しない単元がある。それぞれの単元、難易度にあった問題10問ずつをそれぞれJsonファイルに作成して。
また、各問題のフォーマットは添付の形式として
Mediumのjsonファイルから作成して。

[
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「今日は【 】が良くて、空がとてもきれいです。」",
        "options": [
            "てんき",
            "でんき",
            "せんき",
        ...
        "correct": 0,
        "hint": "空がきれいな様子を表す言葉を考えてみましょう。",
        "explanation": "「天気」は「てんき」と読み、その日の空模様や気象状態を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の中に、大切な手紙を入れました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "物を入れる容器を表す言葉を考えてみましょう。",
        "explanation": "「箱」は「はこ」と読み、物を入れる四角い容器を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の上に、新しい本を置きました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "勉強や仕事をする時に使う家具を表す言葉を考えてみましょう。",
        "explanation": "「机」は「つくえ」と読み、勉強や仕事をする時に使う家具を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の中に、たくさんの魚が泳いでいます。」",
        "options": [
        ...
        "correct": 0,
        "hint": "広い水の場所を表す言葉を考えてみましょう。",
        "explanation": "「海」は「うみ」と読み、広い水の場所を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の上で、友だちとかけっこをしました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "家の外にある平らな場所を表す言葉を考えてみましょう。",
        "explanation": "「庭」は「にわ」と読み、家の外にある平らな場所を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の中で、おいしいごはんを食べました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "家の中の区切られた空間を表す言葉を考えてみましょう。",
        "explanation": "「部屋」は「へや」と読み、家の中の区切られた空間を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の中に、新しい服をしまいました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "衣類を収納する家具を表す言葉を考えてみましょう。",
        "explanation": "「箪笥」は「たんす」と読み、衣類を収納する家具を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の上に、きれいな花を飾りました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "物を置く板を表す言葉を考えてみましょう。",
        "explanation": "「棚」は「たな」と読み、物を置くための板を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の中に、大切な写真を入れました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "物を入れて持ち運ぶ道具を表す言葉を考えてみましょう。",
        "explanation": "「鞄」は「かばん」と読み、物を入れて持ち運ぶ道具を表す言葉です。"
    },
    {
        "question": "次の文の【 】に入る言葉として最も適切なものを選んでください。\n\n「【 】の上に、おいしいケーキを並べました。」",
        "options": [
        ...
        "correct": 0,
        "hint": "食べ物を載せて運ぶ道具を表す言葉を考えてみましょう。",
        "explanation": "「お盆」は「おぼん」と読み、食べ物を載せて運ぶ道具を表す言葉です。"
    }
]
